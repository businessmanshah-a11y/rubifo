...
ERROR_MESSAGES = {
    ...
    "route_limit_reached": "❌ شما حداکثر کانال‌های مقصد مجاز را ایجاد کرده‌اید.",
...
Rubifo کار تکراری ادمین بارگذاری را حذف می‌کند و پست‌ها را در روبیکا منظم منتشر می‌کند.

📌 **تریال شما:** 72 ساعت برای تست زمان‌بندی ساده
💳 **بعد از تریال:** /buy برای آزاد شدن همه امکانات؛ محدودیت فقط تعداد کانال مقصد است.

🚀 **شروع سریع:**
1️⃣  /addroute - کانالی را انتخاب کنید
2️⃣  /addplan - برنامه‌ی فوروارد را تنظیم کنید
3️⃣  بدون آپلود دستی در پنل، صف و انتشار خودکار انجام می‌شود!
...
def format_subscription_info(tier: str, end_date) -> str:
    ...
    tier_names = {"basic": "📦 شروع حرفه‌ای", "pro": "⭐ رشد", "enterprise": "👑 مقیاس"}
